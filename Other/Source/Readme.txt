...
user in an INI file next to ResourceHackerPortable.exe called 
ResourceHackerPortable.ini. If you are happy with the default options, it is 
...
ResourceHackerPortable.ini next to ResourceHackerPortable.exe. The options in 
